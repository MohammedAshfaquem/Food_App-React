...
const LandingPage = () => {
  return (
    <>
      <Navbar />
      <div className="flex flex-col lg:flex-row items-center justify-between px-6 md:px-12 lg:px-20 py-10 gap-10">
        <div className="w-full lg:w-1/2 text-center lg:text-left ml-0 lg:ml-10">
