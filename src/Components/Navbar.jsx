    ...
    <nav className="bg-purple-400 text-white font-bold">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between md:ml-20">
        ...
        <ul className="hidden md:flex gap-8 text-sm font-medium">
          <li className="cursor-pointer" onClick={() => scrollToSection("top")}>Home</li>
          <li className="cursor-pointer" onClick={() => scrollToSection("popularfoods")}>Popular</li>
          <li className="cursor-pointer" onClick={() => scrollToSection("services")}>Services</li>
          <li className="cursor-pointer" onClick={() => navigate("/orders")}>Orders</li>
        </ul>
        ...
        <div className="flex items-center gap-4 relative text-black">
          ...
          <div className="relative">
            <User className="cursor-pointer hover:text-blue-500" onClick={() => setDropDown(!dropDown)} />
            {dropDown && (
      ...
      {isOpen && (
        <div className="md:hidden bg-white text-black px-4 py-4 space-y-3 shadow">
          <div className="cursor-pointer hover:text-purple-600" onClick={() => scrollToSection("top")}>Home</div>
          <div className="cursor-pointer hover:text-purple-600" onClick={() => scrollToSection("popularfoods")}>Popular</div>
          <div className="cursor-pointer hover:text-purple-600" onClick={() => scrollToSection("services")}>Services</div>
          <div className="cursor-pointer hover:text-purple-600" onClick={() => navigate("/orders")}>Orders</div>
        </div>
      )}
    </nav>
  );
